...
function displayDiceImg(){
    ...
    diceimg.setAttribute('src','https://th.bing.com/th/id/R.7f49543e6128809116a3bdbbfe1d94bc?rik=GOYI6TqmCTQDIQ&riu=http%3a%2f%2fpngimg.com%2fuploads%2fdice%2fdice_PNG141.png&ehk=s9umZyXz8ye%2bRSQxtmxmEjvWOOOkXqKVBnmBaCX0q4A%3d&risl=&pid=ImgRaw&r=0')
...
function fourthImage(){
    if(clickbait<1){
     ...
     congo.setAttribute('src','https://www.badhaai.com/wp-content/uploads/2021/04/promotion-wishes-to-father.png')
     congo.setAttribute('id','congoImg')
     congo.style.width = '400px'
     showdigit.innerHTML = 'your coupon code ('+ ans+")"
